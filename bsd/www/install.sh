...
for file in webtop webtop-cgi visit-proxy visit-total-proxy site/index.html site/index.previous.html site/pdp11.jpg site/pdp1183-web.jpg site/tmog-banner-v2.jpg site/pdp1173-tmog-preview-v1.jpg site/health.txt
do
    test -s "$file" || exit 1
done
...
for file in pdp11.jpg pdp1183-web.jpg tmog-banner-v2.jpg pdp1173-tmog-preview-v1.jpg index.previous.html health.txt
do
